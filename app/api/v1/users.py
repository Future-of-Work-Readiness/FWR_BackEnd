...
from app.services import UserService, BenchmarkService
...
def register(data: UserRegisterRequest, db: Session = Depends(get_db)):
    ...
    return {
        ...
        "user": {
            ...
            "name": new_user.name,
            "preferred_specialization_id": str(new_user.preferred_specialization_id) if new_user.preferred_specialization_id else None,
